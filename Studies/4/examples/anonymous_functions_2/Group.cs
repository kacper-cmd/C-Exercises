using System;
    ...
    partial class Group
    {
        ...
        // when this group will generate a notification
            //meeting += new GroupEvent(newPerson.answer);

        // here anonymous method is used instead 'callback' method
            meeting += delegate (object whoCalls, EventArgs ev)
            {
                Console.WriteLine(newPerson.Name + " " + newPerson.Surname
                    + " says: I received a call from " + (whoCalls as Group).Name);
            };
    }
        ...
        public void add(Person newPerson)
        {
            ...
            //meeting += newPerson.answer;

        // here lambda expression is used instead 'callback' method
            meeting += (whoCalls, ev) =>
            {
                Console.WriteLine(newPerson.Name + " " + newPerson.Surname
                    + " says: I received a call from " + (whoCalls as Group).Name);
