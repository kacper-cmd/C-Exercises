using System;
    ...
    partial class Group
    {
        ...
        // adds meetingResponse() method as a callback for meeting event
        // other words, we prepare newly added object of Person, what it has to do if its group calls for a meeting

            meeting += new GroupEvent(newPerson.meetingResponse);
        ...
        public void add(Person newPerson)
        {
            ...
            meeting += newPerson.meetingResponse;
        }
